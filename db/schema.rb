...
ActiveRecord::Schema.define(version: 20160701191304) do
  ...
  add_index "members", ["child_id"], name: "index_members_on_child_id", using: :btree
  ...
  add_foreign_key "members", "children"
